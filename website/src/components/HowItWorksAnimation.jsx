...
export default function HowItWorksAnimation({ lang = 'en' }) {
  ...
  return (
    <div className="w-full select-none py-8 overflow-x-auto">
      <div className="min-w-[1100px] max-w-7xl mx-auto">
        <div className="flex gap-6">
          <div className="flex-1 min-w-0">
            <div ref={aiWindowRef} className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl shadow-2xl border border-gray-700 overflow-hidden flex flex-col" style={{ height: '480px', minHeight: '480px', maxHeight: '480px' }}>
          ...
          <div className="flex-1 min-w-0">
            <div ref={browserWindowRef} className={`bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl shadow-2xl border overflow-hidden flex flex-col transition-all duration-500 ${browserActive ? 'border-emerald-700' : 'border-gray-700'}`} style={{ height: '480px', minHeight: '480px', maxHeight: '480px' }}>
      ...
      <div className="min-w-[1100px] max-w-7xl mx-auto mt-6">
